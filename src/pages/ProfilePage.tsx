...
import { getDatabase, ref as dbRef, set, onValue, orderByChild, equalTo, query } from "firebase/database"
...
const ProfilePage: React.FC = () =>{
    ...
    //Jeg fikk håndtert det sånn nogen lunde til slutt, men koden ble ikkke spesielt fin
    ...
    const getAllUserUrls = async () =>{
        ...
        currentUserImageData?.map( (imageData) =>{
            getImageUrl(imageData.imageName).then((imageUrl: any) =>{
                ...
                console.log("Image urls in function")
