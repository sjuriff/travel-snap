...
const MyImagesList: React.FC<ImageListProp> =  ({files}) =>{
    ...
    //wrappe hele koden inn i useCallBack. Prøve med Memo og useMemo først
    ...
    const Item: React.FC<ItemProp> = useCallback( ({image}) =>{
        ...
        const removeLikedByUser = async (name: string) =>{
            ...
            console.log("usersIdArray before filter")
            ...
            console.log("userIdArray after filter")
            console.log(userIdArray)
